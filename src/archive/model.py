...
def parse_argument():
    ...
    parser.add_argument(
        "--training_cap", help="training data market cap", required=True
    )
    parser.add_argument(
        "--training_range", help="number of training date", required=True
    )
    ...
    parser.add_argument(
        "--yearly_seasonality", help="data yearly seasonality", required=False
    )
...
def model_training(
    data, growth, changepoints=None, holidays=None, yearly_seasonality=True
):
    model = Prophet(
        growth=growth,
